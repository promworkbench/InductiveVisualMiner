...
public class Animation {
	...
	public static void positionTrace(TimedTrace timedTrace, UnfoldedNode unode, Tokens tokens, InductiveVisualMinerPanel panel) {
...
//		System.out.println(" enter " + unode + " @" + token.getLastTime());
