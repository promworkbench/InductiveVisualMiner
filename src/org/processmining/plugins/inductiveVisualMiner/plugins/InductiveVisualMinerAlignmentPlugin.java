...
public class InductiveVisualMinerAlignmentPlugin {
	...
	public JComponent visualise(final PluginContext context, InductiveVisualMinerAlignment ivmAlignment,
		...
		InductiveVisualMinerState state = new InductiveVisualMinerState(ivmAlignment.getXLog(), ivmAlignment.getModel(),
				ivmAlignment.getAlignedLog());
