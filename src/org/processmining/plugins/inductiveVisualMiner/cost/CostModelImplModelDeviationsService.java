 ...
 *
 */
public class CostModelImplModelDeviationsService extends CostModelAbstract {
	...
	public CostModelImplModelDeviationsService(IvMModel model, IvMLogInfo logInfoFiltered) {
		super(model);
	...
	public String getName() {
		return "model, deviations & service time";
	}
