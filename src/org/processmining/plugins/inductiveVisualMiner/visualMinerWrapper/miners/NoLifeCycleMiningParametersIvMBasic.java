...
public class NoLifeCycleMiningParametersIvMBasic extends MiningParameters {
	
	/*
	 * No other parameter, except mentioned in this file, has influence on the mined model
	 */
	
	public NoLifeCycleMiningParametersIvMBasic() {
		//determine algorithm
		...
		//set the reduce parameters to not use the pro variant
		EfficientTreeReduceParameters reduceParameters = new EfficientTreeReduceParameters(false);
		reduceParameters.setPro(false);
		setReduceParameters(reduceParameters);
	}
}
