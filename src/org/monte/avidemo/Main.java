...
public class Main {
    ...
    public static void test(File file, Format format) throws IOException {
    	ImageOutputStream fileStream = new FileImageOutputStream(file);
        testWriting(fileStream,format);
        try {
        testReading(file);
    ...
    public static void testWriting(ImageOutputStream file, Format format) throws IOException {
